...
# Bot information
SESSION = environ.get('SESSION', 'AiBotz')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002059188477 -1002034191943 -1001999856728 -1002120440582 -1001990311618 -1001989994741 -1002112539735 -1002075357366').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# auth_channel means force subscribe channel.
auth_channel = environ.get('AUTH_CHANNEL', '-1002144427738') # give your force subscribe channel id here else leave it blank
auth_grp = environ.get('AUTH_GROUP', '-1002133979377') # give your force subscribe group id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002133979377')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001957898674')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://haroonhassan3:haroonhassan3@haroonhassan3.7zzzhoe.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "haroonhassan3")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'PLEASE_DONT_TRY_TO_FIND_ME') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AI_BOTZ_SUPPORT')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/the_ai_botz')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/the_ai_botz')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/the_ai_botz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'AI_BOTZ_SUPPORT') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://ai-filter-pro-ai-botz65.koyeb.app/")
